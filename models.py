...
class TokenStatus(str, enum.Enum):
    BOOKED     = "booked"       # pre-booked for a future date, not yet active
    CREATED    = "created"
    ACTIVE     = "active"
...
class AppointmentSlot(Base):
    ...
    slot_date  = Column(Date, nullable=False, index=True)   # 2026-03-22
    slot_time  = Column(String, nullable=False)              # "09:00"
    slot_end   = Column(String, nullable=True)               # "09:30"
